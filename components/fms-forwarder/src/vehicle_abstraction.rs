...
const SNAPSHOT_VSS_PATHS: &[&str] = &[
    ...
    VSS_VEHICLE_TRIP_DURATION,
    VSS_VEHICLE_AVERAGE_SPEED,
    VSS_VEHICLE_TRAVELED_DISTANCE_SINCESTART,
    VSS_VEHICLE_CHASSIS_AXIS_ROW1_WHEEL_LEFT_BRAKE_PADWEAR,
    VSS_VEHICLE_EMISSIONS_CO2,
];
